...
class ReorderItems extends StatefulWidget {
  ...
  /// See also:
  ///
  ///   * [ReorderItems.builder], which allows you to build a reorderable
  ...
  /// created in advance, or all at once when the [ReorderItems] itself
  /// is created, it is more efficient to use the [ReorderItems]
  ...
  /// [ReorderItems.builder] constructor. Using the [IndexedWidgetBuilder], The
  ...
  /// See also:
  ///
  ///   * [ReorderItems], which allows you to build a reorderable
  ///     list with all the items passed into the constructor.
  const ReorderItems.builder({
    super.key,
  ...
  @override
  State<ReorderItems> createState() => _ReorderItemsState();
}
...
class _ReorderItemsState extends State<ReorderItems> {
  ...
  Widget _itemBuilder(BuildContext context, int index) {
    ...
    assert(() {
      if (item.key == null) {
        throw FlutterError(
          'Every item of ReorderItems must have a key.',
        );
      }
      return true;
    }());
    ...
    final Key itemGlobalKey = _ReorderItemsChildGlobalKey(item.key!, this);
...
@optionalTypeArgs
class _ReorderItemsChildGlobalKey extends GlobalObjectKey {
  const _ReorderItemsChildGlobalKey(this.subKey, this.state) : super(subKey);
  ...
  bool operator ==(Object other) {
    ...
    return other is _ReorderItemsChildGlobalKey &&
        other.subKey == subKey &&
        other.state == state;
  }
