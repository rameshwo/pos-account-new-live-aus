...
class NewModiSec extends StatefulWidget {
  ...
  @override
  State<NewModiSec> createState() => _NewModiSecState();
}

class _NewModiSecState extends State<NewModiSec> {
  void _grouping() {
  ...
  Widget build(BuildContext context) {
    ...
    _placeOrder = Provider.of<PlaceOrderPro>(context);
    return Container(
              ...
              children: [
                Text.rich(
                  TextSpan(text: widget.title, children: [
                    if ((widget.maxThresholdQuantity?.inDouble ?? 0) != 0)
                      TextSpan(
                        text:
