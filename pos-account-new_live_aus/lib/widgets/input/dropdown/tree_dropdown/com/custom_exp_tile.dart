...
/// [CusExpTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [CusExpTile].
///
/// {@tool dartpad}
/// This example demonstrates different configurations of CusExpTile.
///
...
class CusExpTile extends StatefulWidget {
  ...
  @override
  State<CusExpTile> createState() => _ExpansionTileState();
}

class _ExpansionTileState extends State<CusExpTile>
      ...
      child: Column(
        ...
        children: <Widget>[
          ListTileTheme.merge(
            ...
            child: ListTile(
              visualDensity:
                  (widget.dense ?? false) ? VisualDensity.compact : null,
              onTap: widget.onTap,
              dense: widget.dense,
  ...
  void didChangeDependencies() {
    ...
    _headerColorTween
      ..begin = widget.collapsedTextColor ?? theme.textTheme.titleSmall!.color
