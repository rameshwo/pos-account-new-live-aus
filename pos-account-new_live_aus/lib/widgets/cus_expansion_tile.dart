...
/// [CusExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [CusExpansionTile].
///
/// {@tool dartpad}
/// This example demonstrates different configurations of CusExpansionTile.
///
...
class CusExpansionTile extends StatefulWidget {
  ...
  final Function(Function())? assignFunction;
...
class _CusExpansionTileState extends State<CusExpansionTile>
  ...
  void initState() {
    ...
    if (widget.assignFunction != null) widget.assignFunction!(_handleTap);
  }
