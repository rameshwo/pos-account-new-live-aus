...
//   //     (event) {
//   //       log("connected displays changed: $event");
//   //     },
//   //   );
//   //   super.initState();
//   // }
...
//               // values?.forEach((e) {
//               //   // log("-------- Display id:${e.a}, flag: ${e.b}, rot: ${e.c}, name:${e.d}");
//               // });
//               displays.clear();
//               setState(() {
...
//                 child: Center(
//                     child:
//                         Text(' ${displays[index]?.a} ${displays[index]?.d}')),
//               );
//             }),
//         const Divider()
//       ],
...
//                     displayId: displays.isNotEmpty
//                         ? displays[index]?.a.toString() ?? "-1"
//                         : "1",
//                     routerName: SecondScreen.routeName);
//               }
//             }),
//         const Divider(),
//       ],
